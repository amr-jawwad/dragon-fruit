...
def CalculateTimeToNextOrder(Data: pd.DataFrame, COUNT_FAILED_ORDERS: bool):
    ...
    Grouped = Grouped.rename({"order_date":"days_to_next_order"},axis=1)
    Grouped.days_to_next_order = Grouped.days_to_next_order.shift(-1)
    Grouped.days_to_next_order = Grouped.days_to_next_order.dt.days
