...
def test_calculate_is_returning_customer_counting_failed():
    ...
    assert (is_matching(result_df.days_to_next_order.to_numpy(),[1.0, 2.0, 1.0, 9.0, 47.0, np.nan])), "Some values in the day_diff were incorrect"
...
def test_calculate_is_returning_customer_not_counting_failed():
    ...
    assert (is_matching(result_df.days_to_next_order.to_numpy(),[np.nan, 2.0, 10.0, np.nan, 47.0, np.nan])), "Some values in the day_diff were incorrect"
